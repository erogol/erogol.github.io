...
description: "Lately, we (TwentyBN(https://www"
tags: action activitynet besnet challenge deep learning
minute: 6
---
...
![](https://web.archive.org/web/2020/http://https://web.archive.org/web/2020/http://erogol.com/wp-content/uploads/2017/07/activitynbet2017.jpg)
...
![](https://web.archive.org/web/2020/http://https://web.archive.org/web/2020/http://erogol.com/wp-content/uploads/2017/07/besnet_module.png)

BesNet module excluding residual connection. d [1,2] describes random selection of dilation factor between 1 or 2. Dimensions are sequence x height x width.
...
![](https://web.archive.org/web/2020/http://https://web.archive.org/web/2020/http://erogol.com/wp-content/uploads/2017/07/1d-dilation.png)

Dilation in 1D with increasing dilation factor per layer. The aim here to increase receptive field exponentially with less network paramerters. In our case we set dilation factor random thus our network is able to learn more  relations that are also corresponding to gray shade nodes and connections.
...
3. [Selfai: A Method for Understanding Beauty in Selfies](http://www.erogol.com/selfai-predicting-facial-beauty-selfies/ "Selfai: A Method for Understanding Beauty in Selfies")
